...
package com.dekaisheng.courier.xzing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = DisplayUtil.dip2px(120);  //240;
	private static final int MIN_FRAME_HEIGHT = DisplayUtil.dip2px(120); //240;
	private static final int MAX_FRAME_WIDTH = DisplayUtil.dip2px(480);  // 480;
	private static final int MAX_FRAME_HEIGHT = DisplayUtil.dip2px(180); //360;
